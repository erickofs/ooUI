"""Proxy tab — start/stop controls, status LED, verbose/debug flags, and live log console."""
...
class ProxyTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._chk_verbose = QCheckBox(t("proxy.chk_verbose"))
        self._chk_verbose.setToolTip("Pass --verbose to ooproxy.py")
        controls_layout.addWidget(self._chk_verbose)

        self._chk_debug = QCheckBox(t("proxy.chk_debug"))
        self._chk_debug.setToolTip("Pass --debug to ooproxy.py")
        controls_layout.addWidget(self._chk_debug)
    ...
    def _on_start_clicked(self) -> None:
        ...
        self._controller.start_proxy_with_dpapi(url, extra_flags=extra_flags)
